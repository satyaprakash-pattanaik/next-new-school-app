...
const schema = z.object({
  ...
  birthday: z.date({message:"Bithday is required!"}),
...
const onSubmit = handleSubmit(data => {
    ...
    return (
        <form className="flex flex-col gap-8" onSubmit={onSubmit}>
            ...
            <span className="text-xs text-gray-400 font font-medium">Authentication Information</span>
            ...
            <span className="text-xs text-gray-400 font font-medium">Personal Information</span>
            <div className="flex justify-between flex-wrap gap-4">
                <InputField
                label="First Name"
                name="firstName"
